            ...
            {Array.from({ length: totalVariants }, (_, i) => i + 1).map(v => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs text-slate-400 mt-1">{count} ta savol</p>
                </button>
              );
            })}
          </div>
    ...
    return (
      <div className="min-h-screen bg-[#F0F2F5] flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-[2.5rem] shadow-xl p-10 text-center">
          ...
          <h2 className="text-2xl font-black text-slate-900 mb-2">Bon Travail!</h2>
          <p className="text-slate-500 mb-8">Variant {state.selectedVariant} yakunlandi.</p>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            <div className="bg-slate-50 p-4 rounded-2xl">
              ...
              <p className="text-xs text-slate-400 uppercase tracking-wider font-semibold">Natija</p>
            </div>
          </div>
